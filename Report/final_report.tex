...
\begin{itemize}
	...
	\item Longer hair increases the impedance and therefore lowers the SNR. Additionally it is hardware to fixate the electrodes precisely on the scalp when using conventional elastic bandages.
